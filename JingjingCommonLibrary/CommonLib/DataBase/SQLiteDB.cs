...
namespace Jingjing.CommonLib.DataBase
{
    ...
    public class SQLiteDB
    {
        ...
        /// <returns></returns>
        private SQLiteConnection GetConnection(string DataFilePath)
        {
            try
            {
        ...
        /// </summary>
        /// <param name="DataFilePath">数据库文件的位置</param>
        public void CreateNewDatabase(string DataFilePath)
        {
            try
            {
        ...
        public DataTable SelectDataTable(string DataFilePath, string SqlString, SQLiteParameter[] SqliteParameters)
        {
        ...
        /// <param name="SqliteParameters">SQL语句的参数数组</param>
        public void UpdateDataTable(DataTable dt, string DataFilePath, string SqlString, SQLiteParameter[] SqliteParameters)
        {
            conn = GetConnection(DataFilePath);
            try
            {
        ...
        public int ExecuteNonQuery(string DataFilePath, string SqlString, SQLiteParameter[] SqliteParameters)
        {
            conn = GetConnection(DataFilePath);
            try
            {
        ...
        public object ExecuteScaler(string DataFilePath, string SqlString, SQLiteParameter[] SqliteParameters)
        {
            conn = GetConnection(DataFilePath);
            try
            {
        ...
        public void ExecuteSqliteTransaction(string DataFilePath, string[] SqlStrings, SQLiteParameter[][] SqliteParameters)
        {
            conn = GetConnection(DataFilePath);
            try
            {
